...
## Project Overview
This repository showcases QA/SDET work on a sample **Fintech — Payment Collections** application. It is a portfolio project built with dummy/sample data only — no real client names, production data, or confidential information are included.
